...
import type { Question } from "./useCurrencyGuess";
// ⛔️ Removed: import { CURRENCY_SUGGESTIONS } from "./useCurrencyGuess";
...
export default function CurrencyGuessBoard({ phase, question, onSubmit }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <input
          type="text"
          placeholder="Type the currency name or ISO code (e.g., Euro / EUR)…"
          value={guess}
          onChange={(e) => setGuess(e.target.value)}
          disabled={disabled}
          // ⛔️ Removed: list attribute (no suggestions)
          style={{
            height: 48,
            borderRadius: 12,
            border: "1px solid rgba(255,255,255,.18)",
          ...
          aria-label="Currency name or code"
          autoComplete="off"
        />
