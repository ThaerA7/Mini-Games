// ==========================================================
// New file: components/guess-games/map-shape/useMapShapeGuess.ts
// Game logic hook (mirrors useFlagGuess with a separate BEST key)
// ==========================================================
...
export function useMapShapeGuess() {
  ...
  const submit = (userInput: string) => {
    ...
    const isCorrect = normalizeName(guessText) === normalizeName(question.answer);
