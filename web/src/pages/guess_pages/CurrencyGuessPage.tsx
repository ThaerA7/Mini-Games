...
import CurrencyGuessBoard from "../../components/guess-games/currency-guess/CurrencyGuessBoard";
import {
  useCurrencyGuess,
  TOTAL_CURRENCY_QUESTIONS,
} from "../../components/guess-games/currency-guess/useCurrencyGuess";

export default function CurrencyGuessPage() {
  const {
    level,
    score,
    bestScore,
          ...
          <div style={{ width: "min(94vw, 800px)", margin: "0 auto" }}>
            ...
            >
              <div style={{ justifySelf: "start", fontWeight: 700 }}>
                Current level: {Math.min(level, TOTAL_CURRENCY_QUESTIONS)}/{TOTAL_CURRENCY_QUESTIONS}
              </div>
              <div style={{ justifySelf: "center" }} />
              <div style={{ justifySelf: "end", fontWeight: 700 }}>
                Best score: {bestScore}/{TOTAL_CURRENCY_QUESTIONS}
              </div>
            </div>
          </div>
            ...
            {showOverlay && (
              ...
              >
                ...
                {phase === "idle" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Currency - start"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, opacity: 0.9 }}>
                      Type the currency name or ISO code. You’ll play through{" "}
                      <b>{TOTAL_CURRENCY_QUESTIONS}</b> countries — each appears only once per run.
                    </div>
                    <button
                      onClick={start}
                ...
                {phase === "wrong" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Currency - wrong answer"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      Correct answer: <b>{question?.canonical}</b>
                    </div>
                    <button
                ...
                {phase === "finished" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Currency - finished"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      You’ve completed all {TOTAL_CURRENCY_QUESTIONS} countries.
                      <br />
                      Final score: <b>{score}/{TOTAL_CURRENCY_QUESTIONS}</b>
                      <br />
                      Best score: <b>{bestScore}/{TOTAL_CURRENCY_QUESTIONS}</b>
                    </div>
                    <button
                      onClick={restart}
