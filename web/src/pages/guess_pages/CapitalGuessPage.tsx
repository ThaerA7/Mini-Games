// pages/guess_pages/CapitalGuessPage.tsx
import * as React from "react";
import TopBar from "../../components/TopBar";
import CapitalGuessBoard from "../../components/guess-games/capital-guess/CapitalGuessBoard";
import {
  useCapitalGuess,
  TOTAL_ITEMS,
} from "../../components/guess-games/capital-guess/useCapitalGuess";
    ...
    >
      ...
      <main style={{ flex: 1, display: "grid", placeItems: "center", padding: 16 }}>
        <section style={{ width: "min(1040px, 100%)", display: "grid", gap: 16 }}>
          ...
          >
            <CapitalGuessBoard phase={phase} question={displayQuestion} onSubmit={submit} />
            ...
            {showOverlay && (
              ...
              >
                ...
                {phase === "idle" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Capital - start"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, opacity: 0.9 }}>
                      Type the capital of the shown country. This run includes{" "}
                      <b>{TOTAL}</b> countries.
                    </div>
                ...
                {phase === "wrong" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Capital - wrong answer"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      That wasn’t one of the accepted capitals for <b>{question?.country}</b>.
                    </div>
                    <button
                ...
                {phase === "finished" && (
                  <div
                    role="dialog"
                    aria-label="Guess the Capital - finished"
                    style={{
                      position: "relative",
                      zIndex: 1,
                      textAlign: "center",
