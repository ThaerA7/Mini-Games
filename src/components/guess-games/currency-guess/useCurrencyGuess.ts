...
const RULES: Rule[] = [
  ...
  group(
    ["US"],
    "USD",
    ["United States dollar", "US dollar", "U.S. dollar"],
    ["American dollar", "Dollar"],
    "$",
  ),
  group(
    ["GB"],
  ...
  group(
    ["CN"],
    "CNY",
    ["Chinese yuan", "Renminbi", "Yuan", "RMB"],
    ["Renminbi yuan", "Rénmínbì"],
    "¥",
  ),
  ...
  group(
    ["PL"],
    "PLN",
    ["Polish zloty", "Polish złoty", "Zloty", "Złoty"],
    ["PLN"],
  ),
  ...
  group(
    ["AE"],
    "AED",
    ["UAE dirham", "United Arab Emirates dirham", "Dirham"],
    ["AED"],
  ),
  ...
  group(
    ["IL"],
    "ILS",
    ["Israeli new shekel", "New shekel", "Shekel", "NIS"],
    ["ILS"],
  ),
  ...
  group(
    ["BA"],
    "BAM",
    ["Convertible mark", "Bosnia and Herzegovina convertible mark", "Marka"],
    ["BAM"],
  ),
  ...
  ...XAF.map((c) =>
    group(
      [c],
      "XAF",
      ["Central African CFA franc", "CFA franc", "Franc"],
      ["FCFA"],
    ),
  ),
  ...XOF.map((c) =>
    group(
      [c],
      "XOF",
      ["West African CFA franc", "CFA franc", "Franc"],
      ["FCFA"],
    ),
  ),
  ...
  group(
    ["PA"],
    "USD",
    ["United States dollar", "US dollar", "U.S. dollar", "Dollar"],
    ["USD"],
  ),
