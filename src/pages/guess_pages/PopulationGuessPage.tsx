                ...
                {phase === "idle" && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, opacity: 0.9 }}>
                      Type your estimate of the country's population. Answers
                      within
                      <b> ±{Math.round(tolerancePct * 100)}%</b> of the official
                      figure count as correct. This run includes <b>{TOTAL}</b>{" "}
                      countries.
                    </div>
                    <button
                      onClick={start}
                ...
                {phase === "won" && (
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      {question ? (
                        <>
                          Official population of <b>{question.country}</b> is{" "}
                          <b>{format(question.population)}</b>.
                        </>
                      ) : null}
                    </div>
                    <button
                ...
                {phase === "wrong" && (
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      {question ? (
                        <>
                          The accepted range was {format(question.acceptedMin)}{" "}
                          – {format(question.acceptedMax)}.
                          <br />
                          Official population for <b>{question.country}</b> is
                          approximately <b>{format(question.population)}</b>.
                        </>
                      ) : (
