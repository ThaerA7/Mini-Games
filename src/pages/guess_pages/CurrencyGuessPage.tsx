          ...
          <div style={{ width: "min(94vw, 800px)", margin: "0 auto" }}>
            ...
            >
              <div style={{ justifySelf: "start", fontWeight: 700 }}>
                Current level: {Math.min(level, TOTAL_CURRENCY_QUESTIONS)}/
                {TOTAL_CURRENCY_QUESTIONS}
              </div>
                ...
                {phase === "idle" && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 13, opacity: 0.9 }}>
                      ...
                      <b>{TOTAL_CURRENCY_QUESTIONS}</b> countries — each appears
                      only once per run.
                    </div>
                    <button
                      onClick={start}
                ...
                {phase === "finished" && (
                  ...
                  >
                    ...
                    <div style={{ opacity: 0.9, fontSize: 14 }}>
                      ...
                      Final score:{" "}
                      <b>
                        {score}/{TOTAL_CURRENCY_QUESTIONS}
                      </b>
                      <br />
                      Best score:{" "}
                      <b>
                        {bestScore}/{TOTAL_CURRENCY_QUESTIONS}
                      </b>
                    </div>
                    <button
                      onClick={restart}
